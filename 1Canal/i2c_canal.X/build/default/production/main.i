...
void ds1337_init(void){
    ...
    I2C1_Write1ByteRegister(0b1101000, 0x00, seconds);
}
void ds1337_get_time(uint8_t *hr, uint8_t *min, uint8_t *sec){
    *sec = bcd2bin( I2C1_Read1ByteRegister(0b1101000 , 0x00) & 0x7f );
    *min = bcd2bin( I2C1_Read1ByteRegister(0b1101000 , 0x01) & 0x7f );
    *hr = bcd2bin( I2C1_Read1ByteRegister(0b1101000 , 0x02) & 0x3f );
}
...
void ds1337_set_date_time(uint8_t day, uint8_t mth, uint8_t year, uint8_t hr, uint8_t min, uint8_t sec){
  ...
  I2C1_Write1ByteRegister(0b1101000, 0x03, bin2bcd(day) );
...
# 92 "main.c"
    ...
    while (1)
    {
        temh = I2C1_Read1ByteRegister(0b0111000, 0x00);
        teml = I2C1_Read1ByteRegister(0b0111000, 0x02);
        teml >>= 6;
        teml *= 25;
